...
Temp_BR_Plot <- ggplot(BRA_complete, aes(x = Date, y = Temperature_C)) +
  geom_line() + geom_smooth(method = "lm")

Rain_BR_Plot <- ggplot(BRA_complete, aes(x = Date, y = Rainfall)) + geom_line()+ geom_smooth(method = "lm")
...
BR_Rain_Components <- as.data.frame(Rain_data_decomp$time.series[,1:3])
BR_Temp_Components <- as.data.frame(Temp_data_decomp$time.series[,1:3])
